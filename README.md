...
**Product & Data-Driven Designer** based in Utrecht, NL — 10+ years across e-commerce,
...
**Data Platforms & Product Analytics**
...
- **[data-science-work-samples](https://github.com/sepidakz/data-science-work-samples)** —
  Three tabular analyses that each reach a negative or corrected result: a churn model that
  fails a permutation test, a parsing bug that invented a customer segment, and the same audit
  redone in SQL. `Python` `scikit-learn` `SQL`
- **[predictpro-recommender](https://github.com/sepidakz/predictpro-recommender)** —
  Modular Python refactor of my MA thesis prototype (built with Monks): TF-IDF content ranking,
  weighted multi-criteria scoring, and a from-scratch NumPy cosine similarity. `Python` `NumPy`
